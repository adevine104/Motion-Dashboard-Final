...
export function Part3Animation() {
    Part3TL.to("#P",{duration:.5, scale:.78, fill:"#6FA3FF", transformOrigin: "left bottom"},"play10")
            ...
            .fromTo("#nav-white-line",{drawSVG:"0%"}, {duration: 3, drawSVG:"25%", ease: "none"}, "play13-0")
            ...
            .fromTo("#nav-white-line",{drawSVG:"25%"}, {duration: 3, drawSVG:"50%", ease: "none"}, "play13-1")
            ...
            .fromTo("#nav-white-line",{drawSVG:"50%"}, {duration: 3, drawSVG:"75%", ease: "none"}, "play13-2")
            ...
            .fromTo("#nav-white-line",{drawSVG:"75%"}, {duration: 3, drawSVG:"100%", ease: "none"}, "play13-3")
            ...
            .to("#car-pointer", {motionPath: {path: "#nav-blue-line", align: "#nav-white-line", autoRotate: true}, duration: 12, ease: "none"}, "play13-0")
